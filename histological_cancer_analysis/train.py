...
from histological_cancer_analysis.logging_utils import build_logger, ensure_output_dirs
...
def train(config: DictConfig) -> None:
    ...
    lightning_module, trainer = build_training_components(config)
    trainer.fit(
        lightning_module,
...
def build_training_components(config: DictConfig) -> tuple[CancerClassifier, pl.Trainer]:
    model = build_model(
